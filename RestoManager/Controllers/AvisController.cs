...
namespace RestoManager.Controllers
{
    public class AvisController : Controller
    {
        ...
        {
            ViewData["NumResto"] = new SelectList(_context.Restaurants, "CodeResto", "NomRest");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CodeAvis,NomPresonne,Note,Commentaire,NumResto")] Avis avis)
        {
            ...
            ViewData["NumResto"] = new SelectList(_context.Restaurants, "CodeResto", "NomRest", avis.NumResto);
            return View(avis);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodeAvis,NomPresonne,Note,Commentaire,NumResto")] Avis avis)
        {
            if (id != avis.CodeAvis)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestoDbContext.Avis'  is null.");
            }
            var avis = await _context.Avis.FindAsync(id);
            if (avis != null)
            {
