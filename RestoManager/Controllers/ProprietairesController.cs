...
namespace RestoManager.Controllers
{
    public class ProprietairesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Numero,Name,Email,Gsm")] Proprietaire proprietaire)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Numero,Name,Email,Gsm")] Proprietaire proprietaire)
        {
